<body>
  <div id="ContactUs">
    ...
    <div id="frameContent" class="card my-3">
    ...
    <form   class="card my-3"role="form" action="index.html" method="post">
      ...
      <button  role="button" class="btn btn-primary" type="submit" name="button" aria-label="Boton para enviar un comentario">Enviar</button>
    </form>
  </div>
</body>
