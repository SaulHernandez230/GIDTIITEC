<body>
  <div id="Antecedentes">
    ...
    <p id="parrafo2">
      ...
      tecnologías inclusivas e innovación educativa, no solo para la Secretaria de Educación Pública, quien se nutriría
      de los resultados de estudios para la toma de decisiones, sino de los diferentes sectores públicos y privados que
    ...
    <p id="parrafo3">
      ...
      resultados pretenden ser productivos para la sociedad nacional y regional.
    </p>
  </div>
  <span class="sr-only" >Exposiencias Nacional 2016 </span>
  <img id="timeLine" src="../../Sources/Img/PROYECTOS DASC.png" aria-label="Participacion del Grupo de desarrollo en Exposiencias ">
</body>
